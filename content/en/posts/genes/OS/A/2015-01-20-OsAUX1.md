...
* **Publication**  
    ...
    + [Rice auxin influx carrier OsAUX1 facilitates root hair elongation in response to low external phosphate.](http://www.ncbi.nlm.nih.gov/pubmed?term=Rice+auxin+influx+carrier+OsAUX1+facilitates+root+hair+elongation+in+response+to+low+external+phosphate.%5BTitle%5D), 2018, Nat Commun.
